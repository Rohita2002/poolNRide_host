...
class Rideentry extends Component {
	...
	showPrice() {
		if (this.props.price === 0) {
			return <p className="RideEntryFieldPrice">free</p>;
		} else {
			return <p className="RideEntryFieldPrice">Rs. {this.props.price}</p>;
		}
	}
						...
						<tr className="RideEntryRow">
							<td>
								<ul className="RideEntryFieldUl">
									<li>Pickup: {this.props.departure}</li>
									<li>Drop-off: {this.props.destination}</li>
								</ul>
							</td>
